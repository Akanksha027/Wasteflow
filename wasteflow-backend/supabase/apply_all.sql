-- WasteFlow full apply for new project elbbxqrkriezcyhqvfww

-- ===== 20260812061651_62012f95-caf2-47df-8dd3-20ba66e7f875.sql =====
...
-- ===== 20260812061703_3e05e1a8-3f93-4be1-9772-aa98a1e1296f.sql =====
...
-- ===== 20260812061715_231c9133-a506-41d1-bd83-e90e7eb70ea4.sql =====

GRANT EXECUTE ON FUNCTION public.has_role(uuid, public.app_role) TO authenticated;
GRANT EXECUTE ON FUNCTION public.is_manager(uuid) TO authenticated;


-- ===== 20260813000000_driver_employee_link.sql =====
-- Driver auth â†” employee link + collection photo storage.
